---
title: "Chapter 10: Learning and Conditioning"
description: "A comprehensive survey of classical conditioning (Pavlov, Watson, taste aversion), operant conditioning (Skinner, reinforcement/punishment schedules), social learning theory (Bandura, Bobo doll, self-efficacy), cognitive maps, latent learning, neuroplasticity, learned helplessness, and the fixed vs. growth mindset."
...
- [Chapter 2: Biological Bases of Behavior](../02-biological-bases-behavior/index.md)
- [Chapter 9: Development: Adolescence Through Adulthood](../09-development-adolescence-adulthood/index.md)
...
**Classical conditioning** — first systematically studied by Ivan Pavlov — is a learning process in which a neutral stimulus comes to elicit a response after it is repeatedly paired with a stimulus that already elicits that response.

### Pavlov's Fundamental Procedure

Pavlov was studying digestive physiology in dogs when he noticed that his dogs began salivating not just at the sight of food but at the sight of the laboratory assistant who brought the food — a "psychic secretion" he eventually made the subject of systematic study.
...
John B. Watson and Rosalie Rayner extended classical conditioning to human emotional reactions in the famous (and ethically troubling) "Little Albert" study. They conditioned a nine-month-old infant to fear a white rat by pairing it with a sudden loud noise (UCS for fear/startle). The infant eventually showed fear (CR) to the rat alone — and via generalization, to other white, fluffy stimuli.

A **conditioned emotional response** is an emotional reaction — fear, pleasure, disgust, nostalgia — that is acquired through classical conditioning. Emotional conditioning is often rapid, powerful, and long-lasting, particularly for fear responses. The amygdala (Chapter 2) is the neural locus of conditioned fear.
...
John Garcia and Robert Koelling's research showed that rats readily form taste–illness associations but do not readily form light/sound–illness associations, even with the same training procedure. Conversely, light and sound pair readily with shock, while taste does not. This **biological preparedness** suggests that evolution has pre-wired certain CS–UCS associations to be especially easy to learn because they were adaptive.

---

## 10.2 Operant Conditioning

**Operant conditioning** — systematically developed by B.F. Skinner, building on Thorndike's Law of Effect — is a learning process in which the frequency of a behavior is modified by its consequences. Unlike classical conditioning (which involves reflexive responses), operant conditioning applies to voluntary behavior.

### The Law of Effect and Skinner's Extension

Edward Thorndike's Law of Effect states: behaviors followed by satisfying consequences are strengthened (stamped in); behaviors followed by unsatisfying consequences are weakened (stamped out). Skinner operationalized this in the **Skinner box** — an operant chamber in which an animal (rat or pigeon) could perform a measurable behavior (pressing a lever, pecking a key) to receive a consequence (food pellet or shock).
...
**Positive reinforcement**: Adding a desirable stimulus following a behavior, increasing the likelihood of that behavior. A rat receives a food pellet when it presses a lever → lever pressing increases.

**Negative reinforcement**: Removing an aversive stimulus following a behavior, increasing the likelihood of that behavior. A rat escapes a mild shock by pressing a lever → lever pressing increases. Note: "negative" refers to removal, not to anything bad — negative reinforcement always *increases* behavior.

**Positive punishment**: Adding an aversive stimulus following a behavior, decreasing the likelihood of that behavior. Touching a hot stove → burn → stove-touching decreases.

**Negative punishment** (response cost): Removing a desirable stimulus following a behavior, decreasing the likelihood of that behavior. A teenager's phone is taken away for missing curfew → curfew-missing decreases.

#### Diagram: Reinforcement vs. Punishment Overview

<details markdown="1">
<summary>Explore: How do the four operant contingencies work?</summary>
...
1. **Positive Reinforcement** (+R): Add something good → behavior increases
   - *Example:* Praise after a student answers a question → student participates more
   - *The most powerful method for building new behaviors*

2. **Negative Reinforcement** (−R): Remove something bad → behavior increases
   - *Example:* Taking ibuprofen removes headache pain → taking ibuprofen increases
   - *Often confused with punishment — remember it always increases behavior*

3. **Positive Punishment** (+P): Add something bad → behavior decreases
   - *Example:* A speeding ticket after driving too fast → speeding decreases
   - *Effective but has side effects: fear, aggression, avoidance of the punisher*

4. **Negative Punishment** (−P): Remove something good → behavior decreases
   - *Example:* Taking away screen time when a child misbehaves → misbehavior decreases
...
**Partial (intermittent) reinforcement** schedules produce slower acquisition but much greater resistance to extinction — because if reinforcement isn't continuous, how long must the organism persist before concluding it's truly unavailable?
...
| **Fixed Interval (FI)** | After a fixed time period | Low rate early, "scallop" shape — acceleration near interval end | Checking for mail that arrives at a fixed time |
...
Classical and operant conditioning were developed within the **behaviorist** tradition — which deliberately excluded unobservable mental states. By the mid-20th century, however, evidence accumulated that mental representations play an important role in learning.

### Latent Learning

Edward Tolman's experiments with rats in mazes challenged strict behaviorism. In a key experiment, one group of rats ran a maze daily for a reward; another group ran the maze without reward for many days, then started receiving reward. The unrewarded rats had not been reinforced for any correct turns — yet when reward was introduced, they quickly matched the performance of the consistently-rewarded group. This demonstrated **latent learning**: learning that occurs without reinforcement and is not immediately expressed in behavior, only revealed when a reason to perform arises.

### Cognitive Maps

Tolman used the term **cognitive map** to describe the internal mental representation of a spatial environment that the rats had apparently built during their unrewarded explorations. Cognitive maps are not limited to spatial layouts — they extend to mental representations of cause–effect relationships, social networks, and abstract conceptual spaces. The existence of cognitive maps implies that learning involves forming internal representations, not just S–R (stimulus–response) connections.

### Learned Helplessness

Martin Seligman and Steven Maier's research with dogs illuminated a phenomenon with profound implications for depression. In the original experiments, dogs were exposed to inescapable electric shocks — shocks that continued regardless of any action the dog took. When these dogs were later placed in a different chamber where they could easily escape shocks by jumping over a barrier, most did not even try — they lay passively and accepted the shock.

**Learned helplessness** is the passive, unresponsive behavior that results from repeated experience with uncontrollable aversive events. The organism "learns" that its responses have no effect on outcomes and generalizes this perception of uncontrollability to new situations. Seligman drew an explicit parallel to human depression: people who experience repeated uncontrollable negative events (job loss, abusive relationships, chronic illness) may develop the cognitive style of attributing negative events to global, stable, internal causes — "I can't do anything right, it's always like this, it's my fault" — which perpetuates helplessness and depression.
...
Albert Bandura proposed that much of human learning occurs not through direct reinforcement but through **observational learning** (also called vicarious learning or modeling) — learning by observing the behavior and consequences of others.

Bandura identified four processes required for effective observational learning:

1. **Attention**: The learner must attend to the model's behavior.
2. **Retention**: The learner must encode and remember what was observed.
3. **Reproduction**: The learner must have the physical and cognitive ability to reproduce the behavior.
4. **Motivation**: The learner must want to perform the behavior — often influenced by observing whether the model was reinforced or punished (**vicarious reinforcement/punishment**).
...
1. **Mastery experiences**: The strongest source. Successfully performing a task increases self-efficacy; repeated failure decreases it.
2. **Vicarious experiences**: Watching similar others succeed ("If they can do it, I can too") raises self-efficacy.
3. **Social persuasion**: Encouragement from credible others can temporarily boost self-efficacy.
4. **Physiological and affective states**: Interpreting arousal (rapid heartbeat before a presentation) as excitement rather than fear supports self-efficacy.

High self-efficacy predicts persistence in the face of obstacles, higher goal-setting, less anxiety, and greater achievement — across academic, athletic, health behavior, and occupational domains.
...
At the cellular level, learning involves **long-term potentiation (LTP)** — repeated activation of a synapse makes that synapse more sensitive and efficient, which is the cellular mechanism underlying the formation of memory traces (covered in Chapters 6–7). Donald Hebb's famous principle — "cells that fire together, wire together" — captures this mechanism.
...
!!! mascot-celebration
    ...
    **Brilliant work completing Chapter 10!**
    ...
    Chapter 11 moves from individual learning to social psychology — how the presence of others changes how we think, feel, and act. Get ready for some of the most famous (and most disturbing) experiments in psychology.
...
- **Acquisition**: The initial learning phase during CS–UCS pairings.
...
1. A child who was bitten by a dog now feels fear (CR) around all large animals — not just dogs. This illustrates ________.

2. A factory worker is paid for every 50 units produced. This is a ________ schedule of reinforcement and produces a ________ rate of responding.

3. A rat that explored a maze without reinforcement for many days quickly learned the correct path when food was introduced. Tolman called the mental representation it had formed a ________.

4. In the Bobo doll study, children who observed an adult being ________ for aggression were *less* likely to imitate the aggressive behavior than children who saw no consequence.

5. According to Dweck, a student who believes that intelligence is fixed and interprets needing to study hard as evidence of low ability has a ________ mindset.

<details markdown="1">
<summary>Show Answers</summary>

1. **Stimulus generalization**
2. **Fixed ratio (FR)**; **high and steady** rate (with post-reinforcement pauses)
3. **Cognitive map**
4. **Punished** (vicarious punishment reduced imitation)
5. **Fixed** mindset
