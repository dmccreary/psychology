---
title: "Chapter 1: Foundations of Psychology and Research Methods"
description: "An introduction to psychology as a science, the scientific method, research designs, ethical standards, statistical reasoning, and the biological foundations of behavior."
...
This chapter introduces psychology as a science and establishes the empirical
tools used throughout the course. Students learn the scientific method, major
research designs (experimental and non-experimental), ethical standards for
human and animal research, and the statistical reasoning needed to interpret
psychological data. The chapter also introduces foundational concepts in
heredity, the nervous system, and evolutionary perspectives that underpin all
later biological content.
...
[course description](../../course-description.md) — no prior psychology
...
!!! mascot-welcome
    <img src="../../img/mascot/welcome.png" alt="Psy the Owl waving" class="mascot-admonition-img">
    **Meet Psy the Owl — your guide through AP Psychology!**
    ...
    1. **Welcome (this one!)** — I appear at the start of every chapter to set the stage and tell you what's coming.
    2. **Thinking** — I pause to pose a question or highlight something worth mulling over before you read on.
    3. **Tip** — I share a test-taking strategy, memory trick, or shortcut for the AP exam.
    4. **Warning** — I flag a common misconception or a place where students typically go wrong.
    5. **Encourage** — I pop up mid-chapter when the material gets tough to remind you that you've got this.
    6. **Celebration** — I appear at the end of every chapter to celebrate what you've just learned.
...
<details markdown="1">
<summary>Interactive: Steps of the Scientific Method</summary>
...
<iframe src="../../sims/scientific-method/index.html"
...
<details markdown="1">
<summary>Interactive MicroSim: Confounding Variables</summary>
...
*File location when built: `docs/sims/confounding-variables/`*
...
## 1.4 Non-Experimental Research Methods
...
!!! mascot-tip
    <img src="../../img/mascot/tip.png" alt="Psy the Owl with a lightbulb" class="mascot-admonition-img">
...
<details markdown="1">
<summary>Interactive: Standard Deviation and the Normal Curve</summary>
...
<iframe src="../../sims/standard-deviation/index.html"
...
1. **Informed consent** — Participants must be told the nature, risks, and benefits of the study in language they understand, and must voluntarily agree to participate *before* the study begins. They may withdraw at any time without penalty.
2. **Confidentiality** — Participants' data and identities must be protected.
3. **Protection from harm** — Physical and psychological harm must be minimized; any risk must be justified by the study's scientific value.
4. **Deception** — Limited deception (e.g., not revealing the true hypothesis) is sometimes permitted, but only when no other method is feasible and only if the deception would not cause harm.
5. **Debriefing** — After the study ends, researchers must fully explain its purpose, disclose any deception, and address any distress caused. **Debriefing in research** is not optional — it is an ethical obligation that restores participants' dignity and ensures they leave without harmful misconceptions.
...
<details markdown="1">
<summary>Interactive MicroSim: APA Ethics Decision Tree</summary>
...
*File location when built: `docs/sims/ethics-decision-tree/`*
*Iframe height when embedded: 620px*

*[MicroSim to be generated — embed once built:]*
```
<iframe src="../../sims/ethics-decision-tree/index.html"
...
## 1.7 Nature, Nurture, and the Biological Bases of Behavior
...
<details markdown="1">
<summary>Interactive Infographic: Neuron Structure</summary>
...
*File location when built: `docs/sims/neuron-structure/`*
*Iframe height when embedded: 550px*

*[MicroSim to be generated — embed once built:]*
```
<iframe src="../../sims/neuron-structure/index.html"
...
<details markdown="1">
<summary>Interactive Infographic: Major Brain Regions</summary>
...
*File location when built: `docs/sims/brain-regions/`*
*Iframe height when embedded: 580px*

*[MicroSim to be generated — embed once built:]*
```
<iframe src="../../sims/brain-regions/index.html"
...
## 1.8 Putting It All Together: From Biology to Behavior
