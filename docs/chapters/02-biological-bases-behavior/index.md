---
title: "Chapter 2: Biological Bases of Behavior: Neurons and the Brain"
description: "An exploration of how biology shapes behavior — covering evolutionary and hereditary foundations, nervous system organization, neuron types, brain structures, hemispheric lateralization, neuroimaging, and sleep."
...
Building on Chapter 1's introduction to neuron structure and basic nervous
system anatomy, this chapter examines how the brain and body produce behavior.
Students explore the full organization of the nervous system — from spinal
reflexes to cortical lobes — and survey the major brain structures and their
behavioral functions. The chapter also covers hemispheric lateralization,
split-brain research, neuroimaging techniques, and states of consciousness
...
<details markdown="1">
<summary>Interactive: Nervous System Divisions Diagram</summary>
...
*File location when built: `docs/sims/nervous-system-organization/`*
...
<details markdown="1">
<summary>Interactive: Neuron Structure Explorer</summary>
...
!!! mascot-tip
    ...
    **AP Exam memory trick for neuron types:**
    ...
    - **M**otor → **M**uscles receive the signal (away from CNS)
    - **I**nterneurons → **I**nside the CNS, **I**ntegrating everything
...
<details markdown="1">
<summary>Interactive: Subcortical Brain Regions Infographic Overlay</summary>
...
*File location when built: `docs/sims/subcortical-brain-regions/`*
*Iframe height when embedded: 680px*
...
<details markdown="1">
<summary>Interactive: Cerebral Cortex Lobes and Split-Brain Experiment</summary>
...
*File location when built: `docs/sims/cortex-split-brain/`*
*Iframe height when embedded: 720px*
...
<details markdown="1">
<summary>Interactive: Neuroimaging Methods Comparison Tool</summary>
...
*File location when built: `docs/sims/brain-imaging-methods/`*
*Iframe height when embedded: 680px*
...
<details markdown="1">
<summary>Interactive: Sleep Stages Timeline and Hypnogram</summary>
...
*File location when built: `docs/sims/sleep-stages-timeline/`*
*Iframe height when embedded: 650px*
