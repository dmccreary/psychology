---
title: "Chapter 14: Health Psychology and Introduction to Psychological Disorders"
description: "Bridges stress biology and clinical classification. Covers health psychology, the biopsychosocial model, stress and behavior (eustress/distress, adverse childhood experiences, GAS, fight-flight-freeze, tend-and-befriend), coping strategies, positive psychology (well-being, resilience, gratitude, signature strengths), and the classification and explanation of psychological disorders (DSM, ICD, perspectives, evidence-based psychotherapy, specific phobia, and an introduction to schizophrenia)."
...
4. Gratitude and Subjective Well-Being
5. Signature Strengths
6. Stress and Behavior
7. Eustress vs. Distress
8. Adverse Childhood Experiences
9. General Adaptation Syndrome
10. Problem-Focused Coping
11. Emotion-Focused Coping
12. Fight-Flight-Freeze Response
13. Tend-and-Befriend Response
14. Defining Psychological Disorders
15. DSM Classification System
16. ICD Classification System
17. Biopsychosocial Model
18. Behavioral Perspective on Disorders
19. Biological Perspective on Disorders
20. Sociocultural Perspective on Disorders
21. Evidence-Based Psychotherapy
22. Schizophrenia
23. Specific Phobia
...
- [Chapter 3: Neurochemistry and Psychopharmacology](../03-neurochemistry-psychopharmacology/index.md)
- [Chapter 13: Personality and Motivation](../13-personality-motivation/index.md)
...
<details markdown="1">
<summary>Explore: What happens to the body during each stage of GAS?</summary>

**Stage 1 — Alarm Reaction**
The initial response to a stressor. The sympathetic nervous system activates the fight-flight-freeze response. Resources are mobilized rapidly: stress hormones flood the system, the immune system briefly activates. Resistance to disease is temporarily *reduced* during this mobilization.
*Duration:* Hours to a few days.

**Stage 2 — Resistance**
The body adapts to the continuing stressor. Stress hormone levels remain elevated, but the organism appears to have recovered. Internal resources (glucose, immune function) are maintained at high cost. The body is defending against the original stressor but becomes *more vulnerable* to other stressors.
*Duration:* Days to weeks.

**Stage 3 — Exhaustion**
If the stressor persists and adaptation resources are depleted, the body enters exhaustion. Immune function collapses, stress-related illness becomes likely (cardiovascular disease, gastrointestinal problems, depression). In extreme cases, organ failure and death can result.
*Duration:* Variable; depends on severity of stressor and individual resources.
...
Schizophrenia involves disturbances in multiple domains:
- **Positive symptoms** (excesses): hallucinations, delusions, disorganized thought
- **Negative symptoms** (deficits): flat affect, social withdrawal, reduced speech, avolition
...
Examples include:
- **Cognitive-behavioral therapy (CBT)**: Strong evidence for depression, anxiety, OCD, PTSD, eating disorders
...
1. According to Selye's General Adaptation Syndrome, during which stage is the organism most vulnerable to *new* stressors even though it appears to have recovered from the original stressor?

2. A student whose father lost his job decides to increase her own hours at work and reduce expenses. This is an example of ________ coping.

3. The biopsychosocial model differs from the purely biomedical model in that it ________.

4. The finding that people who write down three things they are grateful for daily show measurable improvements in well-being is best associated with the subfield of ________ psychology.

5. Why does avoidance of a feared object (like spiders) maintain and worsen a specific phobia rather than reducing it?

<details markdown="1">
<summary>Show Answers</summary>

1. **Resistance stage** — the body has adapted to the original stressor but at high resource cost, leaving it more vulnerable to secondary stressors.
2. **Problem-focused coping** (directly addressing the source of the problem — financial stress — by changing behavior).
3. It incorporates **psychological and social factors** (not just biological ones) as determinants of health and illness — recognizing that genes and brain chemistry interact with thoughts, behaviors, cultural context, and social support.
4. **Positive** psychology (Seligman's gratitude interventions).
5. Avoidance prevents the feared stimulus from being encountered without negative consequence, so the conditioned fear is never extinguished. Avoidance is **negatively reinforced** (removes anxiety) — it feels good in the short term but maintains the phobia through operant conditioning.
