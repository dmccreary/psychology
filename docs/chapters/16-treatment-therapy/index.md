---
title: "Chapter 16: Treatment and Therapy"
description: "A comprehensive survey of psychological and biological treatments: CBT, psychotropic medications (antidepressants, antianxiety, antipsychotics), ECT, TMS, and biofeedback. Covers key disorders through a treatment lens — PTSD, major depressive disorder, persistent depressive disorder, bipolar I/II disorders, mania, panic disorder, dissociative amnesia/identity disorder, anorexia nervosa, bulimia nervosa, and culture-bound anxiety disorders. Closes with stigma reduction, culturally responsive care, and posttraumatic growth."
...
20. Anorexia Nervosa
21. Bulimia Nervosa
22. Culture-Bound Anxiety Disorders
...
- [Chapter 14: Health Psychology and Introduction to Psychological Disorders](../14-health-psychology-intro-disorders/index.md)
- [Chapter 15: Psychological Disorders](../15-psychological-disorders/index.md)
...
Core CBT principles:
- Thoughts, emotions, and behaviors are interconnected; changing one changes the others.
- Maladaptive cognitions and behaviors can be identified, challenged, and modified through structured techniques.
- The client is an active participant — CBT is skills-based, not insight-oriented.
- Treatment is structured, time-limited, and focused on present problems.
...
<details markdown="1">
<summary>Explore: How do the mood episodes differ between Bipolar I and Bipolar II?</summary>

**Bipolar I:**
- Full mania (≥1 week, severe impairment, may require hospitalization)
- Often includes major depressive episodes (not required for diagnosis)
- Psychotic features possible during mania
- Higher overall severity of illness

**Bipolar II:**
- Hypomania (≥4 days, noticeable mood change, *not* severely impairing, *no* psychosis)
- Major depressive episodes required for diagnosis
- Often misdiagnosed as MDD — the hypomania may feel good and not be reported
- Suicide risk is high (depressive episodes are severe; hypomania can lower inhibitions)

**Why the distinction matters clinically:**
Prescribing antidepressants alone to someone with bipolar disorder can trigger a manic or hypomanic episode (antidepressant "switching"). Bipolar disorders require mood stabilizers (lithium, valproate, lamotrigine) — not just antidepressants. Misdiagnosis as MDD therefore carries real treatment risk.
...
## 16.3 Trauma-Related and Dissociative Disorders
...
1. **Re-experiencing**: Intrusive memories, flashbacks, trauma-related nightmares
2. **Avoidance**: Avoiding trauma-related thoughts, feelings, or external reminders
3. **Negative alterations in cognition/mood**: Persistent negative beliefs, distorted blame, negative emotional states, reduced positive emotion, feeling detached or estranged
4. **Hyperarousal/reactivity**: Hypervigilance, exaggerated startle response, sleep disturbance, irritability, reckless behavior
...
**Antidepressants:**
First-line treatments for major depression, anxiety disorders, OCD, PTSD, and eating disorders.
...
- **Benzodiazepines** (diazepam/Valium, alprazolam/Xanax): Enhance GABA activity; produce rapid anxiolytic, sedative, muscle relaxant effects. Risk of dependence with regular use.
- **Buspirone**: Serotonin partial agonist; anxiolytic without sedation or dependence potential. Takes weeks to work.
- **Beta-blockers** (propranolol): Block peripheral autonomic arousal; used for performance anxiety.

**Antipsychotic Medications:**
- **First-generation (typical) antipsychotics** (haloperidol/Haldol, chlorpromazine): Block D2 dopamine receptors; reduce positive symptoms. Risk of **tardive dyskinesia** (involuntary repetitive movements) with long-term use.
- **Second-generation (atypical) antipsychotics** (clozapine, risperidone, quetiapine): Block dopamine AND serotonin receptors; reduced tardive dyskinesia risk; some efficacy for negative symptoms; metabolic side effects.

**Mood Stabilizers:**
- **Lithium**: Reduces frequency/severity of both manic and depressive episodes in bipolar disorder. Narrow therapeutic window — requires blood level monitoring. Mechanism not fully understood.
- **Anticonvulsants** (valproate, lamotrigine): Used as mood stabilizers in bipolar disorder.
...
1. **Personal strength**: Feeling more capable and resilient than before the trauma.
2. **New possibilities**: Discovering new paths, purposes, or interests that emerged from the struggle.
3. **Relating to others**: Deepened relationships, greater empathy and compassion.
4. **Appreciation for life**: Greater appreciation for each day, shifted priorities toward what truly matters.
5. **Spiritual/existential change**: Deepened spiritual life or reconsidered understanding of meaning.
...
- **Major depressive disorder (MDD)**: Two-week episode of depressed mood/anhedonia plus symptoms; monoamine dysregulation; treated with CBT, antidepressants.
- **Persistent depressive disorder**: Chronically depressed mood for ≥2 years; fewer/less severe symptoms than MDD.
- **Mania**: Elevated/irritable mood, decreased sleep, grandiosity, impulsive risk-taking; defines bipolar I.
- **Bipolar I**: At least one full manic episode.
- **Bipolar II**: Hypomania + major depression; no full mania.
- **PTSD**: Re-experiencing, avoidance, negative cognition/mood, hyperarousal following trauma.
- **Dissociative amnesia**: Memory loss for important autobiographical information, usually trauma-related.
- **Dissociative identity disorder**: Two or more distinct identity states; associated with severe childhood trauma.
- **Panic disorder**: Recurrent unexpected panic attacks + persistent concern about future attacks.
- **Anorexia nervosa**: Severe caloric restriction, low body weight, body image distortion; highest psychiatric mortality.
- **Bulimia nervosa**: Binge-purge cycles; self-evaluation driven by body shape/weight.
- **Culture-bound anxiety disorders**: Culturally specific distress patterns (*ataque de nervios*, *taijin kyofusho*, *koro*).
- **Cognitive-behavioral therapy (CBT)**: Integration of cognitive restructuring and behavioral techniques; most empirically supported.
- **Antidepressants**: SSRIs, SNRIs, TCAs, MAOIs; increase monoamine activity; treat depression, anxiety, OCD.
- **Antianxiety medications**: Benzodiazepines (fast, dependence risk), buspirone (slow, no dependence).
- **Antipsychotics**: Block dopamine (typical) or dopamine+serotonin (atypical); reduce positive symptoms.
- **Dopamine hypothesis**: Excess mesolimbic dopamine activity underlies positive symptoms of schizophrenia.
- **ECT**: Electrical seizure induction under anesthesia; highly effective for treatment-resistant depression.
- **TMS**: Magnetic cortical stimulation; FDA-approved for treatment-resistant depression; outpatient, no anesthesia.
- **Biofeedback**: Real-time physiological feedback enabling voluntary control of bodily states.
- **Stigma in mental health**: Social disapproval and discrimination that delays help-seeking and compounds impairment.
- **Posttraumatic growth**: Positive psychological change emerging from the struggle with trauma.

### Practice Questions

1. A patient with bipolar I disorder presents during a depressive episode. Why is it important to identify the bipolar diagnosis before prescribing antidepressants?

2. A therapist treats panic disorder by having the client voluntarily induce physical sensations (hyperventilating, spinning) while simultaneously challenging the belief that these sensations mean something dangerous. This combines ________ (exposure to bodily cues) with ________ (restructuring catastrophic interpretations).

3. What is the key difference between anorexia nervosa and bulimia nervosa in terms of weight status and compensatory behavior?

4. ECT is associated with ________ in popular culture, but modern ECT is administered under ________ and has among the highest efficacy rates for ________ depression.

5. According to Tedeschi and Calhoun's framework, posttraumatic growth arises not from the trauma itself but from ________.

<details markdown="1">
<summary>Show Answers</summary>

1. Antidepressants prescribed without a mood stabilizer can **trigger a manic or hypomanic episode** in someone with bipolar disorder — potentially causing more harm than the original depression.
2. **Interoceptive exposure** (inducing physical sensations) + **cognitive restructuring** (challenging catastrophic misinterpretation of sensations). This is CBT for panic disorder.
3. **Anorexia**: significantly **low body weight**; food restriction is the primary behavior. **Bulimia**: weight is typically in the **normal range**; binge-eating followed by purging/compensatory behavior. Both involve body image disturbance.
4. ECT is associated with **fear, abuse, and punishment** in popular culture; modern ECT is administered under **general anesthesia**; it has among the highest efficacy rates for **treatment-resistant** depression.
5. From **effortful cognitive and emotional processing of the trauma** — the active struggle with the experience, not the trauma event itself.

</details>

---

## Appendix: The 16-Chapter Learning Journey

You have now completed all 16 chapters of this AP Psychology intelligent textbook. Here is a brief map of how the content connects:

| Chapters | Domain |
|----------|--------|
| 1 | Scientific foundations |
| 2–3 | Biological bases: brain, neurons, neurotransmitters |
| 4–5 | Sensation, perception, cognition |
| 6–7 | Memory: encoding, storage, retrieval |
| 8–9 | Development: prenatal through adulthood |
| 10 | Learning and conditioning |
| 11–12 | Social psychology |
| 13 | Personality and motivation |
| 14–16 | Health, disorders, and treatment |

The AP Psychology exam tests your ability to apply concepts — not just define them. Use the practice questions, key terms, and interactive elements throughout this textbook to practice applying each concept to novel scenarios. Good luck!
