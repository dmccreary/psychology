...
|---|---------|-------|--------|-------|
| 1 | Concepts | 387 | Required | Concepts from learning graph |
...
| 9 | Words | 90,899 | Required | Words across student-facing markdown |
...
| Equations | 9 | 0 | LaTeX expressions (inline and display) |
| Total Words | 90,899 | 82,025 | Words in markdown files |
| Links | 69 | 28 | Hyperlinks in markdown format |
| Equivalent Pages | 380 | 345 | Estimated pages (250 words/page + visuals) |
